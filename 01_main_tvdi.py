...
from funciones import descarga, mosaico, filldata, recorte, descarga2
from funciones import fn_tvdi, subirtiff, filtro_media
from funciones import hdfToTiff, fillgaps, anomalia

tiles = ["h10v09","h11v08","h11v09","h11v10","h11v11","h11v12","h12v08","h12v09","h12v10","h12v11","h12v12","h12v13","h13v09","h13v10","h13v11","h13v12","h13v13","h13v14","h14v09","h14v10","h14v11","h14v14"]
...
path = "/home/jrubio/Documentos/VENVS/SANCOR4/" #Directorio principal de procesamiento
...
uw_mask = path + "datos/mascara/mask_urbano_agua_i4.tif" #Raster máscara zona de zonas urbanas y cuerpos de agua
uw_mask2 = path + "datos/mascara/mask_urbano_agua_4.tif" #Raster máscara zona de zonas urbanas y cuerpos de agua
...
descarga(url,appkey,tiles,[prods[0]],fecha_lst8,path_descarga,path_xml)

#descarga2(url,username,password,tiles,prods,fecha,path_descarga,path_xml)
#descarga2(url,username,password,tiles,[prods[0]],fecha_lst8,path_descarga,path_xml)
...
for vnp in lista_lst8:
	res = hdfToTiff(vnp, path_proc+'lst8_temp/', dataset[0], lst_nodata)
...
out_tvdi_5km_filt = filtro_media(tvdi_mask, smooth_tvdi_path, uw_mask, uw_mask2)
##ANOMALIA
smooth_anom_path = path_anomalias + "tvdi/anomalias_m_5km/" #Directorio resultado de procesamiento
out_anom_5km_filt = filtro_media(tvdi_anom, smooth_anom_path, uw_mask, uw_mask2)
